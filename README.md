...
## Environments
- Preview: https://main--institut-roche--aemysites.aem.page/
- Live: https://main--institut-roche--aemysites.aem.live/
- Block Library: https://main--institut-roche--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `institut-roche` directory in your favorite IDE and start coding :)
